...
// Экстренный фикс для кнопки закрытия
setTimeout(function() {
    const closeBtn = document.getElementById('closeInviteModal');
    const modal = document.getElementById('inviteModal');
    
    if (closeBtn && modal) {
        console.log('Найден элемент closeInviteModal, добавляем обработчик...');
        ...
        console.log('closeInviteModal:', closeBtn);
        console.log('inviteModal:', modal);
    }
